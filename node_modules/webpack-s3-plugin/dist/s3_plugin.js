	...
	module.exports = function () {
	  ...
	  _createClass(S3Plugin, [{
	    ...
	    value: function isIncludeAndNotExclude(file) {
	      ...
	      var isInclude = include ? include.test(file) : true;
	      var isExclude = exclude ? exclude.test(file) : false;
	    ...
	    value: function invalidateCloudfront() {
	      ...
	      return new Promise(function (resolve, reject) {
	        if (cloudfrontInvalidateOptions.DistributionId) {
	          ...
	          var accessKeyId = _clientConfig$s3Optio.accessKeyId;
	          var secretAccessKey = _clientConfig$s3Optio.secretAccessKey;
